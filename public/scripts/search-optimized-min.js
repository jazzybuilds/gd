...
XA.component.search.baseView = function() {
...
XA.component.search.box = function(n) {
    var i = {},
        ...
        h = XA.component.search.baseView.extend({
            ...
            suggestionSelected: function(t, i) {
                t.preventDefault();
                var f = this.model.get("dataProperties").suggestionsMode,
                    u = n(i.html).text(),
                    e = u != "" ? u : i.html,
                    r;
                switch (f) {
                    ...
                    default:
                        r = n(i.html).find("a");
                        r.length && (window.location.href = n(r[0]).attr("href"))
                }
            },
            updateQueryWithRedirect: function(n) {
                ...
                var f = this.model.get("dataProperties").resultPage,
                    ...
                    r = this.$el.find(".search-box-input.tt-input").val(),
            ...
            performSearch: function(n) {
                var i = this.model.get("dataProperties"),
                    r = i.targetSignature,
                    e = i.searchResultsSignature,
                    u = i.resultPage,
                    o = this.model.get("sig"),
                    f = {};
                this.closeDropdown();
                u === "" ? (this.updateQueryModel(n), this.$el.find(".search-box-input.tt-input").blur().val(n)) : (f = r !== "" ? this.updateSignaturesHash([r + "_q"], n, this.createOffsetObject()) : this.updateSignaturesHash(o, n, this.createOffsetObject()), window.location.href = t.createRedirectSearchUrl(u, f, e, r))
            },
            ...
            updateSearchBoxValue: function() {
                for (var i = r.parseHashParameters(window.location.hash), u = this.$el.find(".search-box-input.tt-input"), t = this.model.get("sig"), n = 0; n < t.length; n++) i.hasOwnProperty(t[n]) ? u.val(i[t[n]]) : u.val("")
            },
    ...
    return i.init = function() {
        if (!n("body").hasClass("on-page-editor") && !e) {
            ...
            o = XA.component.search.results.searchResultModels;
...
XA.component.search.facet.dropdown = function(n) {
    ...
    var i = {},
        ...
        f = XA.component.search.baseModel.extend({
            defaults: {
                template: "<% _.forEach(results, function(result){" + "%><option data-facetName='<%= result.Name !== '' ? result.Name : '_empty_' %>' <%= result.Selected !== undefined ? 'selected' : '' %> ><%= result.Name !== '' ? result.Name : emptyText %> (<%= result.Count %>)<\/option><%" + "}); %>",
                dataProperties: {},
                blockNextRequest: !1,
                resultData: {},
                optionSelected: !1,
        ...
        e = XA.component.search.baseView.extend({
            ...
            render: function() {
                var t = this,
                    e = t.model.get("resultData"),
                    r = this.$el.find(".facet-dropdown-select"),
                    o = t.model.get("dataProperties").emptyValueText,
                    u = this.$el.find(".facet-heading > span"),
                    f = r.find("option:first"),
                    i = n("<option />"),
                ...
                i.text(f.text());
                i.data("facetname", "");
                this.model.get("optionSelected") ? u.addClass("has-active-facet") : f.data("facetname") === "" && u.removeClass("has-active-facet");
                r.empty().append(i).append(h)
            },
...
XA.component.search.facet.managedrange = function(n) {
    var i = {},
        ...
        o = XA.component.search.baseView.extend({
            ...
            clearFilter: function() {
                for (var i = this.$el.find(".manualRangeMin"), r = this.$el.find(".manualRangeMax"), f = this.model.get("dataProperties"), s = this.$el.data("properties"), o = this.$el.find(".facet-heading > span"), e = t.parseHashParameters(window.location.hash), u = this.model.get("sig"), n = 0; n < u.length; n++) delete f[u[n]], e[u[n]] = "";
                t.updateHash(e);
                this.model.set({
                    dataProperties: f
                });
                ...
                i.length > 0 && i.val(i.data().defaultvalue);
                r.length > 0 && r.val(r.data().defaultvalue)
            },
...
XA.component.search.loadMore = function(n) {
    ...
    return r = Backbone.Model.extend({
        ...
        initialize: function() {
            var t = this.$el.data(),
                n = this;
            t.properties.searchResultsSignature === null && (t.properties.searchResultsSignature = "");
            this.model && this.model.set("sig", t.properties.searchResultsSignature.split(","));
            XA.component.search.vent.on("results-loaded", function(t) {
...
XA.component.search.locationfilter = function(n) {
    ...
    var i = {},
        ...
        s, h, e;
    return e = function() {
        for (var t, n = 0; n < r.length; n++) t = new h({
            el: r[n],
            model: new s
        })
    }, s = Backbone.Model.extend({
        ...
        addressLookup: function() {
            ...
            switch (t.mode) {
                ...
                case "UserProvided":
                    ...
                    break;
                case "Mixed":
                    typeof n.text == "undefined" || n.text === "" ? this.detectLocation() : this.translateUserLocation(n)
            }
        },
        getAddress: function() {
            var u = this.$el.find(".location-search-box-input.tt-input"),
                n = u.length !== 0 ? u.val() : this.$el.find(".location-search-box-input").val(),
                f = t.parseHashParameters(window.location.hash),
                i = this.model.get("sig"),
                r;
            return (n === "" || typeof n == "undefined") && (r = f[i.length > 0 && i[0] !== "" ? i[0] + "_a" : "a"], r !== "" && (n = r), typeof n == "undefined" && (n = "")), n
        },
        ...
        searchTextChanges: function(n) {
            return (n.stopPropagation(), n.keyCode === 13) ? (this.addressLookup(n), !1) : !0
        },
        ...
        createHashObject: function(n, t) {
            for (var f = this.model.get("sig"), i, u = {}, r = 0; r < f.length; r++) i = f[r], u[i !== "" ? i + "_g" : "g"] = n, u[i !== "" ? i + "_o" : "o"] = t;
            return u
        }
    }), i.init = function() {
...
XA.component.search.pageSelector = function(n) {
    var i = {},
        t, r = !1,
        u, f;
    return facetName = "e", u = Backbone.Model.extend({
        defaults: {
            dataProperties: {},
            resultsCount: 0,
            offset: 0,
        ...
        handleLoadedData: function(n) {
            var e = this,
                u = this.model.get("dataProperties").properties.searchResultsSignature.split(","),
                o = t.parseHashParameters(window.location.hash),
                f, i, r;
            for (typeof n.offset == "undefined" && (n.offset = 0), r = 0; r < u.length; r++) encodeURIComponent(u[r]) === n.searchResultsSignature && (n.pageSize > n.dataCount || n.offset > n.dataCount ? (this.updateModelAfterSearch(n, 1), setTimeout(function() {
                i = t.parseHashParameters(window.location.hash);
                n.searchResultsSignature !== "" ? i[n.searchResultsSignature + "_e"] = 0 : i.e = 0;
                Backbone.history.navigate(e.createFirstPageUrlHash(i), {
                    trigger: !0,
                    replace: !0
                })
            }, 100)) : (f = Math.ceil(n.offset / n.pageSize) + 1, this.updateModelAfterSearch(n, f)))
        },
    ...
    var n = Backbone.Model.extend({
        ...
        parseHashParameters: function(n) {
            ...
            for (n = n || window.location.hash, u = {}, t = n.slice(n.indexOf("#") + 1).split("&"), t = t.filter(function(n) {
                    return n !== ""
                }), i = 0; i < t.length; i++) r = t[i].split("="), f = r[0].toLowerCase(), u[decodeURIComponent(f)] = r.length > 1 ? decodeURIComponent(r[1].replace("+", " ")) : null;
            return u
        },
...
XA.component.search.results = function(n) {
    ...
    var t = {},
        ...
        s = Backbone.Model.extend({
            ...
            initialize: function() {
                ...
                n.hasOwnProperty(r) && this.set("loadMoreOffset", parseInt(n[r]));
        ...
        h = Backbone.View.extend({
            initialize: function() {
                var t = this.$el.data(),
                    i = this.$el.find(".no-results").html(),
                    n = this;
    ...
    }, t.searchResultViews = r, t.searchResultModels = u, t
}(jQuery, document);
        ...
        r = Backbone.View.extend({
            initialize: function() {
                ...
                XA.component.search.vent.on("results-loaded", function(i) {
                    ...
                    t.html(n.resultsCountText.replace("{query}", "search query goes here"));
                    n.$el.find(".results-count").show()
                })
            }
        });
...
XA.component.search.facet.resultsfilter = function(n) {
    var r = {},
        f, t, e, u = !1,
        o = XA.component.search.baseModel.extend({
            defaults: {
                template: "<div class='facet-search-filter'><% _.forEach(facet.Values, function(value){" + "%><p class='facet-value' data-facetValue='<%= value.Name !== '' ? encodeURI(value.Name) : '_empty_' %>'>" + "<span><%= value.Name !== '' ? value.Name : emptyText %> " + "<span class='facet-count'>(<%= value.Count %>)<\/span>" + "<\/span><\/p><% }); %><\/div>",
                templateMulti: "<div class='facet-search-filter'><% _.forEach(facet.Values, function(value){" + "%><p class='facet-value' data-facetValue='<%= value.Name !== '' ? encodeURI(value.Name) : '_empty_' %>'>" + "<input type='checkbox' name='facetValue' />" + "<label for='facetName'><%= value.Name !== '' ? value.Name : emptyText %> " + "<span class='facet-count' data-facetCount='<%= value.Count %>'>(<%= value.Count %>)<\/span>" + "<\/label><\/p><% }); %><\/div>",
                dataProperties: {},
                blockNextRequest: !1,
                resultData: {},
                timeStamp: "",
            ...
            updateFacetArray: function(n) {
                var i, r, t;
                if (n) {
                    for (i = n.split(","), r = this.get("facetArray"), t = 0; t < i.length; t++) r.push(i[t]);
                    this.set({
        ...
        s = XA.component.search.baseView.extend({
            ...
            render: function() {
                var n = this,
                    ...
                    i = this.model.get("sig"),
                    o, s, h;
                window.location.href.startsWith("file://") || (r !== undefined && (o = n.model.get("dataProperties").multi === !0 ? _.template(n.model.get("templateMulti")) : _.template(n.model.get("template")), h = o({
                    facet: r,
                    emptyText: l
                })), n.$el.find(".contentContainer").html(h), _.each(c, function(t) {
                    var r, u;
                    for (s = t.toLowerCase(), r = 0; r < i.length; r++)
                        if (!jQuery.isEmptyObject(_.pick(e, i)) && (u = _.values(_.pick(e, i))[0], u)) {
                ...
                f.multi ? _.each(e, function(t) {
                    if (u.length > 1)
                        for (var i = 0, f = u.length; i < f; i++) r = s.$el.find("[data-facetvalue]").filter(function() {
                            return n(this).attr("data-facetvalue").toLowerCase() === u[i]
    ...
    var t = function(n) {
        ...
        i = Backbone.Model.extend({
            ...
            createMultiFacetUrl: function(n, t, i, r) {
                ...
                return u += "?f=" + t.join(",").toLowerCase(), u += n.s ? "&s=" + n.s : "", u += n.l ? "&l=" + n.l : "", u += n.q ? "&q=" + encodeURIComponent(n.q) : "", u += r ? "&itemid=" + r : "", u += this.getFacetParams(n, i), u + ("&sig=" + encodeURIComponent(i))
            },
            ...
            getFacetParams: function(n, i) {
                ...
                for (facet in n) o.indexOf(facet) === -1 && facet && n[facet] && (u = facet.substring(facet.indexOf("_") + 1), f = facet.substr(0, facet.indexOf("_")), i === f && e.indexOf(u) === -1 && (r += "&" + u + "=" + encodeURI(t(n[facet]))));
            ...
            createGetGeoPoiContentUrl: function(n, t, i, r, u) {
                var f = this.setEndpoint(n.endpoint);
                return f + ("/" + i + "/" + t + "/" + r + "/" + u)
            },
            createSiteUrl: function(n, t) {
                return typeof t != "undefined" && t !== null && t !== "" ? n + "&sc_site=" + t + "&site=" + t : n
            },
...
XA.component.search.service = function(n) {
    ...
    return e = Backbone.Model.extend({
        ...
        getEndpointAndSearch: function() {
            typeof XA.component.map.getSearchEndpoint() != "undefined" ? this.getSearchData() : setTimeout(this.getEndpointAndSearch.bind(this), 100)
        },
...
XA.component.search.router = function(n) {
    ...
    var t = {},
        i, r = !1,
        u;
    return u = Backbone.Router.extend({
        routes: {
            "*params": "checkUrl"
        },
        checkUrl: function() {
            ...
            n ? XA.component.search.facet.data.filterFacetData(n) : XA.component.search.facet.data.getInitialFacetData();
    ...
    return i = function(t) {
        ...
        render: function() {
            var h = parseInt(this.model.get("dataProperties").fromDateDefaultOffset),
                ...
                o = t.parseHashParameters(window.location.hash),
                e = this.model.get("sig"),
                p = n("html").attr("lang") ? n("html").attr("lang") : "",
                s, i;
            for (f && (f = f.replace(/yy/g, "y")), u && (u = u.replace(/yy/g, "y")), k && (v.datepicker({
                ...
                }), $xa.datepicker.setDefaults($xa.datepicker.regional[p])), d && (y.datepicker({
                    dateFormat: f,
                    changeMonth: a,
                    changeYear: a,
                    maxDate: b ? c != "" ? c : new Date(2100, 1, 1) : new Date
                }), $xa.datepicker.setDefaults($xa.datepicker.regional[p])), i = 0; i < e.length; i++) o.hasOwnProperty(e[i]) && o[e[i]] != "" && (s = o[e[i]].split("|"), v.datepicker("setDate", r(s[0])), y.datepicker("setDate", r(s[1])))
        },
        updateFacet: function() {
        ...
        clearFilter: function() {
            var r = this.model.get("dataProperties"),
                ...
                i = this.model.get("sig"),
                n;
            for (u.removeClass("has-active-facet"), n = 0; n < i.length; n++) delete r[i[n]];
            t.updateHash(this.updateSignaturesHash(i, "", f));
            this.model.set({
                dataProperties: r
            });
