...
var preprocessingInstructions = [
    {
        ...
        preprocessNode: function (node) {
            var src = node.attribs && node.attribs.src;
            if (src) {
                node.attribs.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA";
                node.attribs["data-piio"] = src;
            }
        },
    },
    {
