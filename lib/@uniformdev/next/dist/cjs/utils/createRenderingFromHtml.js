...
function createRenderingFromHtml(html, renderingContext, r, placeholderKey, index, components, _config, logger, options) {
    ...
    var processingInstructions = undefined
        || ((_a = options === null || options === void 0 ? void 0 : options.mvc) === null || _a === void 0 ? void 0 : _a.getProcessingInstructions(processNodeDefinitions.processDefaultNode, placeholderComponent, r, index, placeholderKey, renderingContext, logger))
