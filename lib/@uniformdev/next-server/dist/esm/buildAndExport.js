    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    clientRepoDir = '.';
                    if (!!existsSync('./.next/BUILD_ID')) return [3 /*break*/, 2];
                    ...
                    defaultCommand = existsSync('./node_modules/next/dist/bin/next')
                        ? 'node node_modules/next/dist/bin/next build'
                        : 'npx next build';
                    command = getEnv(config.env, 'UNIFORM_PUBLISH_NEXT_BUILD_COMMAND', defaultCommand);
