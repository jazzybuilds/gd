...
export function server(_a) {
    ...
    } : _a, _c = _b.logger, logger = _c === void 0 ? serverLogger : _c, _d = _b.extensionFilter, extensionFilter = _d === void 0 ? defaultExtensionFilter : _d, _e = _b.pathFilter, pathFilter = _e === void 0 ? defaultPathFilter : _e;
    if (!logger) {
    ...
    if (uniformServerConfig.UNIFORM_MODE !== UniformServerMode.preview) {
        if (process.env.NODE_ENV !== 'production') {
            throw new Error("In " + uniformServerConfig.UNIFORM_MODE + " mode, NODE_ENV must be set to 'production' (lowercase) to make sure Next.js next export command works properly");
        }
    ...
    var createAndStartUniformServer = function (nextServer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, createUniformServer(logger, {
