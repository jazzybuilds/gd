...
import { parseGuid, throwException, } from '@uniformdev/common';
...
export function getDatasources(ids, logger, config) {
    return __awaiter(this, void 0, void 0, function () {
                ...
                case 1:
                    ...
                    for (id in datasourcesData) {
                        if (!datasourcesData.hasOwnProperty(id))
                            continue;
                        datasource = convertDataItemToRuntimeItem(datasourcesData[id], undefined, undefined);
                        guid = parseGuid(id);
...
export function getHtml(path, logger, config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2: return [2 /*return*/, _b.apply(_a, [(_c.sent()).toString()])];
                case 3:
                    htmlUrl = getPageUrl(path, 'html', config);
                    logger.debug('Making HTTP request (data): ' + htmlUrl);
                    return [4 /*yield*/, fetchWithRetry(logger, htmlUrl, 3)];
                case 4:
                    response = _c.sent();
                    if (response.status !== 200) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    item = _b.sent();
                    home = item;
                    return [4 /*yield*/, getDatasources(item.datasources || throwException('item.datasources'), logger, config)];
                case 2:
                    datasources = _b.sent();
