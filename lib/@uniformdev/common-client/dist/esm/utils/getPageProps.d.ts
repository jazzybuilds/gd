...
export declare function getDatasources(ids: string[], logger: Logger, config: UniformConfig): Promise<any>;
export declare function getHtml(path: string, logger: Logger, config: UniformConfig): Promise<any>;
