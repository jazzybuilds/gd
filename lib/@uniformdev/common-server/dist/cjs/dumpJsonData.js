            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            itemUrl = pair.path;
                            path = (common_1.trim(common_1.trim(itemUrl, '/'), '/')).toLowerCase();
                                ...
                                return __generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, common_2.fetchWithRetry(logger, common_1.getApiUrlWithToken(config, htmlPath))];
                                        case 1:
                                            request = _d.sent();
                                            if (!(request.status !== 200)) return [3 /*break*/, 4];
                                            _a = ErrorWithData.bind;
                        ...
                        case 2:
                            ...
                            cacheItem = function (id) {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_d) {
                                        switch (_d.label) {
                                            case 0:
                                                itemPath = ('/uniform/api/content/' + sitename + '/item/' + common_1.trim(common_1.trim(id, '/'), '/')).toLowerCase();
                                                return [4 /*yield*/, common_2.fetchWithRetry(logger, common_1.getApiUrlWithToken(config, itemPath))];
                                            case 1:
                                                request = _d.sent();
                                                if (!(request.status !== 200)) return [3 /*break*/, 4];
                                                _a = ErrorWithData.bind;
                            ...
                            ds = page.datasources || common_1.throwException("ds");
                            i = 0;
                            _a.label = 3;
                        case 3:
