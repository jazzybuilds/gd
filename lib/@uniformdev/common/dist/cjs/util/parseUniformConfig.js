...
function parseUniformConfig(env, runtime) {
    ...
    var UNIFORM_OPTIONS_PREFETCH_LINKS = __1.getEnv(env, 'UNIFORM_OPTIONS_PREFETCH_LINKS', '0');
    var UNIFORM_OPTIONS_MVC_SUPPORT = __1.getBoolEnv(env, 'UNIFORM_OPTIONS_MVC_SUPPORT', false);
    var UNIFORM_OPTIONS_MVC_MODE = __1.getEnv(env, 'UNIFORM_OPTIONS_MVC_MODE', 'mvconly') === 'mvconly' ? 'mvconly' : 'mixed';
    ...
    var UNIFORM_REACT_RENDERINGS = __1.getEnv(env, 'UNIFORM_REACT_RENDERINGS', '');
    return {
